								...
								<table cellpadding="0" cellspacing="0">
											...
											<table cellpadding="0" cellspacing="0">
												<tr>
													<td align="left" style="padding-left: 10px;  padding-right: 10px;">
														<h1 style="font-size: 18px;">Hi <?php echo (isset($barista))?$barista:'';?>!</h1>
														<p>You have a new order to process.</p>
														<p><?php echo (isset($username) && $username != '' ? $username : ''); ?> ordered for a <?php echo (isset($itemOrdered) && $itemOrdered != '' ? $itemOrdered : ''); ?></p>
									...
									<tr>
										<td align="center" style="padding-top: 10px; padding-left: 15%; padding-right: 15%; text-align: center;">
                                          ...
                                          Item: <?php echo (isset($itemOrdered) && $itemOrdered != '' ? $itemOrdered : ''); ?> <br>
                                          Ordered By: <?php echo (isset($username) && $username != '' ? $username : ''); ?><br>
