...
<tr>
											...
											<table cellpadding="0" cellspacing="0">
												<tr>
													<td align="left" style="padding-left: 10px;  padding-right: 10px;">
														<h1 style="font-size: 18px;"><?php echo (isset($location) && $location != '' ? $location : ''); ?> </h1>
									...
									<tr>
										<td align="center" style="padding-top: 10px; padding-left: 15%; padding-right: 15%; text-align: center;">
											<table cellpadding="0" cellspacing="0">
												<tr>
													<td align="left" style="padding-left: 10px;  padding-right: 10px;">
														<h1 style="font-size: 18px;">Hi <?php echo (isset($username) && $username != '' ? $username : 'there!'); ?>!</h1>
														<p>Thanks for purchasing <?php echo (isset($itemOrdered) && $itemOrdered != '' ? $itemOrdered : ''); ?></p>
													</td>
												</tr>
											</table>
										</td>
									...
									<tr>
										<td align="center" style="padding-top: 10px; padding-left: 15%; padding-right: 15%; text-align: center;">
											<table cellpadding="0" cellspacing="0">
												<tr>
													<td align="left" style="padding-left: 10px;  padding-right: 10px;">
														Order Id: <?php echo (isset($orderTag) && $orderTag != '' ? $orderTag : ''); ?> <br>
                                          Product Price: <?php echo (isset($price) && $price != '' ? $price : ''); ?>  <br>
                                          
                                          Amount Paid: <?php echo (isset($userPaid) && $userPaid != '' ? $userPaid : ''); ?> <br>
                                          Credit Balance: <?php echo (isset($balanceCredits) && $balanceCredits != '' ? $balanceCredits : ''); ?><br>
                                          Time of Order: <?php echo (isset($dateOfPurchase) && $dateOfPurchase != '' ? $dateOfPurchase : ''); ?>
													</td>
												</tr>	
											</table>
										</td>
									...
									<tr>
										<td align="center" style="padding-top: 10px; padding-left: 15%; padding-right: 15%; text-align: center;">
											<table cellpadding="0" cellspacing="0">
												<tr>
													<td align="left" style="padding-left: 10px;  padding-right: 10px;">
                                              <img itemprop="contentURL"  src="<?php echo (isset($subProductImage) && $subProductImage != '' ? $subProductImage : ''); ?>" >
													</td>
												</tr>	
											</table>
										</td>
									...
									<tr>
										<td class="footer" align="center" valign="center" style="height: 56px; border-top-color: #C9CBCD; border-top-width: 1px; border-top-style: solid; padding-left: 15%; padding-right: 15%;">
											<span style="color: #C9CBCD; font-size: 12px; "></span> 
										</td>
									</tr>
								</table>
							</td>
